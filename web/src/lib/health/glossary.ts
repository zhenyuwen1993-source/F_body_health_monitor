...
export const GLOSSARY: Record<string, MetricInfo> = {
  ...
  vo2max: {
    key: "vo2max",
    name: "心肺适能（VO₂Max）",
    what: "身体运动时能利用氧气的最大能力，手表在户外快走/跑步时估算。数值越高，心肺引擎越强。",
    why: "它是长期健康最有力的预测指标之一，和耐力、精力、慢病风险都相关。",
    healthy: "因年龄性别而异；相比绝对值，更值得关注它是在涨还是在跌。",
    unit: "ml/kg/min",
    notes: "手表是估算值，偏保守；需要户外步行或跑步记录才会更新。",
  },
  hr_recovery: {
    key: "hr_recovery",
    name: "心率恢复",
    what: "剧烈运动停止后 1 分钟内，心率能降下来多少次。",
    why: "降得越快说明自主神经切换越灵，是心脏健康的经典指标。",
    healthy: "常见参考：1 分钟降 18 次以上算健康，30 次以上很好；持续低于 12 次建议关注。",
    unit: "次/分",
  },
  daylight_min: {
    key: "daylight_min",
    name: "晒太阳",
    what: "白天暴露在自然光下的时间（手表的环境光估算）。",
    why: "白天的自然光帮助校准生物钟，对晚上入睡和情绪都有帮助。",
    healthy: "常见建议每天 20–30 分钟以上户外光照；上午的光效果最好。",
    unit: "分钟",
  },
  hr_zone: {
    key: "hr_zone",
